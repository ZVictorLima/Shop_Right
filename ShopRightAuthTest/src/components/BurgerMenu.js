...
export default function BurgerMenu({ departments, onDepartmentClick }) {
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (onDepartmentClick) {
                    onDepartmentClick(department.name); // Notify parent first
                  }
                  toggleMenu(); // Close the menu after notifying the parent
                }}
              >
