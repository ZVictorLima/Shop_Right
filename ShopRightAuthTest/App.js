...
import PlanogramSuccess from './src/components/PlanogramSuccess';
import PlanogramViewer from './src/components/PlanogramViewer';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        {/* Manage Users Page */}
        <Stack.Screen
          name="ManagePage" // Ensure this matches the AdminControls navigation
          component={ManageUsers} // Reference the correct component
        ...
        {/* Planogram Success */}
        <Stack.Screen
          name="PlanogramSuccess"
          component={PlanogramSuccess}
          options={{ headerTitle: 'Planogram Success' }}
        />
        <Stack.Screen
          name="PlanogramViewer"
          component={PlanogramViewer}
          options={{ headerTitle: '' }}
        />
      </Stack.Navigator>
    </NavigationContainer>
